...
class Bind(Setting):
    ...
    desc = """\
        ...
        Multiple addresses can be bound. ex.::
            ...
            $ gunicorn -b 127.0.0.1:8002 -b [::1]:8002 test:app
...
class Env(Setting):
    ...
    desc = """\
        ...
        .. code-block:: console
            ...
            $ gunicorn -b 127.0.0.1:8002 --env FOO=1 test:app
...
class PasteGlobalConf(Setting):
    ...
    desc = """\
        ...
        The variables are passed to the PasteDeploy entrypoint. Example::
            ...
            $ gunicorn -b 127.0.0.1:8002 --paste development.ini --paste-global FOO=1 --paste-global BAR=2
